...
import { formatAddress, formatDateLabel } from '@vkyc/shared/lib/format';
import { DEMO_ASSETS } from '@vkyc/shared/lib/demoAssets';
import { computeReportMatch } from '@vkyc/shared/lib/matchUtils';
import { bandForScore, DEFAULT_THRESHOLDS } from '@vkyc/shared/lib/thresholds';
import { formatRejectionSummary, type SelectedRejectionReasons } from '@vkyc/shared/lib/rejectionReasons';
import type { CallSession } from '@vkyc/shared/data/types';
import type { LivenessAnswer, PanOcrData } from '@vkyc/shared/data/types';
    ...
    <div className="kyc-report bg-surface border border-border rounded-xl overflow-hidden print:shadow-none">
      ...
      <div className="p-4 space-y-4 text-sm">
          ...
          {[
            ...
            <div
              ...
              className={cn(
                ...
                b.band === 'green' ? 'border-success-subtle bg-success-subtle'
                  : b.band === 'amber' ? 'border-warning-border bg-warning-subtle'
                  : b.band === 'red' ? 'border-danger bg-danger-subtle'
                  : 'border-border bg-bg',
              )}
            >
        ...
        <div className="border border-border rounded-lg overflow-hidden">
          ...
          <div className="mx-4 mb-4 px-3 py-2 bg-success-subtle text-success-strong rounded text-xs">
