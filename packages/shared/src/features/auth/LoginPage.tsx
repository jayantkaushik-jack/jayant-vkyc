...
import { CashfreeLogo } from '../../components/layout/CashfreeLogo';
              ...
              <form onSubmit={handleEmailSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 rounded-lg border border-border focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                    required
                  />
              ...
              <form onSubmit={handleOtpSubmit} className="space-y-4">
                <div>
                  <input
                    ...
                    placeholder="000000"
                    maxLength={6}
                    className="w-full px-3 py-2.5 rounded-lg border border-border text-center text-2xl tracking-[0.5em] focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                  />
                </div>
