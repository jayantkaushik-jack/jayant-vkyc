  ...
  return (
    <div className="bg-surface rounded-xl border border-border shadow-card p-8 flex flex-col items-center justify-center min-h-[280px]">
      <button
        type="button"
        onClick={onGoOnline}
        className="relative w-40 h-40 flex items-center justify-center mb-4 rounded-full transition-transform hover:scale-105 hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-success/40"
      >
